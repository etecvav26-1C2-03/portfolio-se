...
- O sistema embarcado é um sistema operacional, feito para ser utilizado dentro de um equipamento maior podendo ser utilizado em um sensor de movimento, para que sempre que alguem passar na frente do sensor e entrar no local uma lâmpada acenderá automaticamente.
